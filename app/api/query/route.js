            ...
            if (gotPropertyVal) {
              if (propertyType === NOTION_DATA_TYPE_SELECT) {
                ...
                propdata[propertyKey] = {
                  [DGMD_TYPE]: NOTION_DATA_TYPE_SELECT,
                ...
                propdata[propertyKey] = {
                  [DGMD_TYPE]: NOTION_DATA_TYPE_MULTI_SELECT,
                  [DGMD_VALUE]: multis
                };
              }
